...
import { Star, ArrowUpRight, GitCompareArrows, ShieldCheck } from "lucide-react";
...
export default function LaptopCard({
  ...
  return (
    <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-border bg-card transition-shadow duration-[250ms] hover:border-primary/30 hover:shadow-[0_22px_60px_-22px_rgba(124,58,237,0.4)] dark:hover:shadow-[0_22px_60px_-22px_rgba(124,58,237,0.5)]">
      {isRecommended && (
